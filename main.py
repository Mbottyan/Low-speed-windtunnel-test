...
print(pc.pressure_coefficient(q_inf, p_inf, pressure_taps, 5, airfoil_pressure_tap_coordinates, alpha_array))  #if you change the number you cahnge which experemient are you calucalting the cp for
